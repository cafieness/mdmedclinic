  ...
  return (
    <div className="bg-primary pt-32 sm:pt-20 home">
      <div className="md:flex-col flex items-center justify-center ">
        ...
        <div className="sm:w-320">
          ...
          <div className="text-2xl sm:text-xl lg:w-full sm:px-2 mb-12 w-500px text-center" >
             ...
             {isEng?"Cosmetology and Education Clinic of Meerim Davletova": "Клиника косметологии и образования Мээрим Давлетовой"}
          </div>
          <div className="lg:flex-col lg:items-center flex mb-24 items-baseline px-4">
            <ScrollLink
              ...
              duration={500}
            >
              <Button name={isEng?"Make an appointment" :"Записаться на прием"} primary />
            </ScrollLink>
      ...
      <div className=" bg-secondary flex py-24 items-center flex-col ">
        <p className="text-4xl mb-24 text-center">{isEng?"Popular procedures":"Популярные процедуры"}</p>
        <div className="grid grid-cols-3  sm:grid-cols-1">
          <Link to="/procedure/Отбеливание">
            <ProcedureCard img={pr1} text={isEng?"Whitening":"Отбеливание"} />
          </Link>
          <Link to="/procedure/Лечение угревой болезни">
            <ProcedureCard img={pr2} text={isEng?"Treatment of acne":"Лечение угревой болезни"} />
          </Link>
          <Link to="/procedure/Омоложение">
            <ProcedureCard img={pr3} text={isEng?"Rejuvenation":"Омоложение"} />
          </Link>
          <Link to="/procedure/Лечение выпадающих волос">
            <ProcedureCard img={pr4} text={isEng?"Treatment of hair loss":"Лечение выпадающих волос"} />
          </Link>
          <Link to="/procedure/Похудение">
            <ProcedureCard img={pr5} text={isEng?"Weight loss":"Похудение"} />
          </Link>
          <Link to="/procedure/Эпиляция">
            <ProcedureCard img={pr6} text={isEng?"Epilation":"Эпиляция"} />
          </Link>
        </div>
      </div>
      <div className="bg-light-grey py-24 flex flex-col items-center ">
        <p className="text-center text-4xl mb-24">{isEng?"Products":"Продукция"}</p>
        <ProductCarousel />
      </div>
